...
//                Implements full Cardinal ISA with forwarding & hazard detection
/////////////////////////////////////////////////////////////////////
`timescale 1ns/10ps
...
module cardinal_cpu (
    ...
    input      [0:63]  d_in,       // Data from DMEM (load data)
    output     [0:31]  pc_out,     // PC for IMEM address
    output     [0:31]  addr_out,   // Address for DMEM
    output             memEn,      // DMEM enable
    output             memWrEn,    // DMEM write enable
    output     [0:63]  d_out       // Data to DMEM (store data)
);
