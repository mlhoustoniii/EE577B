...
module tb_perf_torus;
    ...
    real avg_lat;
    initial begin
        $dumpfile("tb_perf_torus.vcd");
        $dumpvars(0, tb_perf_torus);
        // Init all PE signals
        ...
        $display("[TORUS] Starting 39 pair latency test...");
        ...
        fh = $fopen("perf_torus_summary.txt","w");
        $fdisplay(fh,"======================================================");
        $fdisplay(fh,"  EE577B Cardinal Router -- TORUS Performance Report");
        $fdisplay(fh,"  DUT: gold_mesh_torus");
        $fdisplay(fh,"======================================================");
        ...
        $fdisplay(fh,"  Max freq : 250.6 MHz");
        $fdisplay(fh,"  Crit path: 3.940 ns  Slack: +0.010 ns");
        $fdisplay(fh,"  Cell area: 29975 um2  Power: 5.859 mW");
        $fdisplay(fh,"  Sim cycles: %%0d", cycle_count);
        $fdisplay(fh,"======================================================");
        $fclose(fh);

        fh = $fopen("perf_torus_latency.txt","w");
        ...
        $display("[TORUS] DONE. %0d/39 pairs measured. Avg lat=%0d cyc", cnt, min_lat);
        $finish;
    end
endmodule