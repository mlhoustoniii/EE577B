`timescale 1ns/1ps
// tb_perf_torus.v -- TORUS perf TB  DUT:gold_mesh_torus
module tb_perf_torus;
    ...
    integer inj_cyc;
    initial begin
        $dumpfile("tb_perf_torus.vcd"); $dumpvars(0,tb_perf_torus);
        ...
        $display("[TORUS] Testing 36 pairs...");
        ...
        $fdisplay(fh,"======================================================");
        $fclose(fh);
        $display("[TORUS] DONE. %0d/36 pairs ok. Min=%0d Max=%0d Avg=%.1f cyc",
                cnt, mn, mx, avg);
        $finish;
    end
endmodule