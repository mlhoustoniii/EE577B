...
module output_ctrl_torus (
    ...
    // ----------------------------------------------------------
    // torus: packet passes through UNCHANGED (no hop shift)
    //
    // Routing decisions are made fresh at each hop by comparing
    // dst_x/dst_y to the router's own coordinates using modular
    // arithmetic. The packet header is never modified in transit.
    // ----------------------------------------------------------
