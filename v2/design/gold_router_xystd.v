...
//      (passed to all 5 input_ctrl_xystd instances)
//   2. Instantiates input_ctrl_xystd instead of input_ctrl
//   3. Instantiates output_ctrl_xystd instead of output_ctrl
...
module gold_router_xystd #(
    ...
    // ----------------------------------------------------------
    // Input Controller Instantiations (xystd variant)
    // ROUTER_X and ROUTER_Y propagated to each controller
    // ----------------------------------------------------------

    input_ctrl_xystd #(.ROUTER_X(ROUTER_X), .ROUTER_Y(ROUTER_Y)) ic_north (
        .clk         (clk),
        .reset       (reset),
    ...
    input_ctrl_xystd #(.ROUTER_X(ROUTER_X), .ROUTER_Y(ROUTER_Y)) ic_south (
        .clk         (clk),
        .reset       (reset),
        .polarity    (polarity_reg),
        .si          (ssi),
    ...
    input_ctrl_xystd #(.ROUTER_X(ROUTER_X), .ROUTER_Y(ROUTER_Y)) ic_east (
        .clk         (clk),
        .reset       (reset),
        .polarity    (polarity_reg),
        .si          (esi),
    ...
    input_ctrl_xystd #(.ROUTER_X(ROUTER_X), .ROUTER_Y(ROUTER_Y)) ic_west (
        .clk         (clk),
        .reset       (reset),
        .polarity    (polarity_reg),
        .si          (wsi),
    ...
    input_ctrl_xystd #(.ROUTER_X(ROUTER_X), .ROUTER_Y(ROUTER_Y)) ic_pe (
        .clk         (clk),
        .reset       (reset),
        .polarity    (polarity_reg),
        .si          (pesi),
    ...
    // ----------------------------------------------------------
    // Output Controller Instantiations (xystd variant)
    // Slot/priority ordering IDENTICAL to gold_router.v
    // ----------------------------------------------------------

    output_ctrl_xystd oc_north (
        .clk          (clk),
        .reset        (reset),
        .polarity     (polarity_reg),
